/* Generated by Pyrex 0.9.6.4 on Mon Jun  2 15:30:15 2008 */
...
static PyObject *__pyx_f_10sphinxbase_10NGramModel_apply_weights(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_2 = PyFloat_AsDouble(__pyx_v_wip); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; goto __pyx_L1;}
  __pyx_3 = PyFloat_AsDouble(__pyx_v_uw); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 57; goto __pyx_L1;}
  ngram_model_apply_weights(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1,__pyx_2,__pyx_3);
...
static PyObject *__pyx_f_10sphinxbase_10NGramModel_wid(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_1 = PyString_AsString(__pyx_v_word); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; goto __pyx_L1;}
  __pyx_2 = PyInt_FromLong(ngram_wid(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1)); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 68; goto __pyx_L1;}
  __pyx_r = __pyx_2;
  __pyx_2 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_10sphinxbase_10NGramModel_word(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_1 = PyInt_AsLong(__pyx_v_wid); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; goto __pyx_L1;}
  __pyx_2 = PyString_FromString(ngram_word(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1)); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; goto __pyx_L1;}
  __pyx_r = __pyx_2;
  __pyx_2 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_10sphinxbase_10NGramModel_score(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":116 */
  __pyx_1 = PyString_AsString(__pyx_v_word); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; goto __pyx_L1;}
  __pyx_v_wid = ngram_wid(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1);

  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":117 */
  __pyx_2 = PyObject_Length(__pyx_v_args); if (__pyx_2 == -1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; goto __pyx_L1;}
  ...
  for (__pyx_3 = 0; __pyx_3 < __pyx_v_n_hist; ++__pyx_3) {
    __pyx_4 = PyInt_FromLong(__pyx_3); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 119; goto __pyx_L1;}
    Py_DECREF(__pyx_v_i);
    __pyx_v_i = __pyx_4;
    __pyx_4 = 0;

    /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":120 */
    __pyx_4 = PyObject_GetItem(__pyx_v_args, __pyx_v_i); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 120; goto __pyx_L1;}
    Py_DECREF(__pyx_v_spam);
    __pyx_v_spam = __pyx_4;
    __pyx_4 = 0;

    /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":121 */
    __pyx_1 = PyString_AsString(__pyx_v_spam); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; goto __pyx_L1;}
    __pyx_2 = PyInt_AsSsize_t(__pyx_v_i); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; goto __pyx_L1;}
  ...
  __pyx_4 = PyFloat_FromDouble(logmath_exp(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lmath,__pyx_v_score)); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; goto __pyx_L1;}
  __pyx_5 = PyInt_FromLong(__pyx_v_n_used); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; goto __pyx_L1;}
...
static PyObject *__pyx_f_10sphinxbase_10NGramModel_prob(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":140 */
  __pyx_1 = PyString_AsString(__pyx_v_word); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; goto __pyx_L1;}
  __pyx_v_wid = ngram_wid(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1);

  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":141 */
  __pyx_2 = PyObject_Length(__pyx_v_args); if (__pyx_2 == -1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; goto __pyx_L1;}
  __pyx_v_n_hist = __pyx_2;
  ...
  for (__pyx_3 = 0; __pyx_3 < __pyx_v_n_hist; ++__pyx_3) {
    __pyx_4 = PyInt_FromLong(__pyx_3); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 143; goto __pyx_L1;}
    Py_DECREF(__pyx_v_i);
    __pyx_v_i = __pyx_4;
    __pyx_4 = 0;

    /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":144 */
    __pyx_4 = PyObject_GetItem(__pyx_v_args, __pyx_v_i); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 144; goto __pyx_L1;}
    Py_DECREF(__pyx_v_spam);
    __pyx_v_spam = __pyx_4;
    __pyx_4 = 0;

    /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":145 */
    __pyx_1 = PyString_AsString(__pyx_v_spam); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 145; goto __pyx_L1;}
    __pyx_2 = PyInt_AsSsize_t(__pyx_v_i); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 145; goto __pyx_L1;}
    (__pyx_v_hist[__pyx_2]) = ngram_wid(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1);
  }
  ...
  __pyx_4 = PyFloat_FromDouble(logmath_exp(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lmath,__pyx_v_score)); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 148; goto __pyx_L1;}
  __pyx_5 = PyInt_FromLong(__pyx_v_n_used); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 148; goto __pyx_L1;}
  __pyx_6 = PyTuple_New(2); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 148; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_6, 0, __pyx_4);
  PyTuple_SET_ITEM(__pyx_6, 1, __pyx_5);
  __pyx_4 = 0;
  __pyx_5 = 0;
