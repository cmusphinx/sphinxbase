/* Generated by Pyrex 0.9.6.4 on Thu May 15 00:31:18 2008 */
...
static int __pyx_f_10sphinxbase_10NGramModel___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_3 = PyFloat_AsDouble(__pyx_v_wip); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; goto __pyx_L1;}
  __pyx_4 = PyFloat_AsDouble(__pyx_v_uw); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; goto __pyx_L1;}
...
static void __pyx_f_10sphinxbase_10NGramModel___dealloc__(PyObject *__pyx_v_self) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":40 */
  logmath_free(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lmath);

  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":41 */
...
static PyObject *__pyx_f_10sphinxbase_10NGramModel_apply_weights(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  Py_INCREF(__pyx_v_wip);
  Py_INCREF(__pyx_v_uw);
  __pyx_1 = PyFloat_AsDouble(__pyx_v_lw); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; goto __pyx_L1;}
  __pyx_2 = PyFloat_AsDouble(__pyx_v_wip); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; goto __pyx_L1;}
  __pyx_3 = PyFloat_AsDouble(__pyx_v_uw); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 54; goto __pyx_L1;}
...
static PyObject *__pyx_f_10sphinxbase_10NGramModel_wid(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_1 = PyString_AsString(__pyx_v_word); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; goto __pyx_L1;}
  __pyx_2 = PyInt_FromLong(ngram_wid(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1)); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; goto __pyx_L1;}
  __pyx_r = __pyx_2;
  __pyx_2 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_10sphinxbase_10NGramModel_word(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_1 = PyInt_AsLong(__pyx_v_wid); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; goto __pyx_L1;}
  __pyx_2 = PyString_FromString(ngram_word(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1)); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; goto __pyx_L1;}
  __pyx_r = __pyx_2;
  __pyx_2 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_f_10sphinxbase_10NGramModel_score(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_1 = PyString_AsString(__pyx_v_word); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; goto __pyx_L1;}
  __pyx_v_wid = ngram_wid(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1);

  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":114 */
  __pyx_2 = PyObject_Length(__pyx_v_args); if (__pyx_2 == -1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 114; goto __pyx_L1;}
  __pyx_v_n_hist = __pyx_2;

  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":115 */
  ...
  for (__pyx_3 = 0; __pyx_3 < __pyx_v_n_hist; ++__pyx_3) {
    __pyx_4 = PyInt_FromLong(__pyx_3); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 116; goto __pyx_L1;}
    Py_DECREF(__pyx_v_i);
    __pyx_v_i = __pyx_4;
    __pyx_4 = 0;

    /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":117 */
    __pyx_4 = PyObject_GetItem(__pyx_v_args, __pyx_v_i); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 117; goto __pyx_L1;}
    Py_DECREF(__pyx_v_spam);
    __pyx_v_spam = __pyx_4;
    __pyx_4 = 0;

    /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":118 */
    __pyx_1 = PyString_AsString(__pyx_v_spam); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; goto __pyx_L1;}
    __pyx_2 = PyInt_AsSsize_t(__pyx_v_i); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 118; goto __pyx_L1;}
  ...
  __pyx_4 = PyFloat_FromDouble(logmath_exp(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lmath,__pyx_v_score)); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; goto __pyx_L1;}
  __pyx_5 = PyInt_FromLong(__pyx_v_n_used); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 121; goto __pyx_L1;}
...
static PyObject *__pyx_f_10sphinxbase_10NGramModel_prob(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":137 */
  __pyx_1 = PyString_AsString(__pyx_v_word); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 137; goto __pyx_L1;}
  __pyx_v_wid = ngram_wid(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1);

  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":138 */
  __pyx_2 = PyObject_Length(__pyx_v_args); if (__pyx_2 == -1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 138; goto __pyx_L1;}
  __pyx_v_n_hist = __pyx_2;

  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":139 */
  __pyx_v_hist = ((int32 *)ckd_calloc(__pyx_v_n_hist,(sizeof(int32))));

  /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":140 */
  for (__pyx_3 = 0; __pyx_3 < __pyx_v_n_hist; ++__pyx_3) {
    __pyx_4 = PyInt_FromLong(__pyx_3); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 140; goto __pyx_L1;}
    Py_DECREF(__pyx_v_i);
    __pyx_v_i = __pyx_4;
    __pyx_4 = 0;

    /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":141 */
    __pyx_4 = PyObject_GetItem(__pyx_v_args, __pyx_v_i); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 141; goto __pyx_L1;}
    Py_DECREF(__pyx_v_spam);
    __pyx_v_spam = __pyx_4;
    __pyx_4 = 0;

    /* "/home/dhuggins/Projects/Sphinx/sphinxbase/python/sphinxbase.pyx":142 */
    __pyx_1 = PyString_AsString(__pyx_v_spam); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 142; goto __pyx_L1;}
    __pyx_2 = PyInt_AsSsize_t(__pyx_v_i); if (PyErr_Occurred()) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 142; goto __pyx_L1;}
    (__pyx_v_hist[__pyx_2]) = ngram_wid(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lm,__pyx_1);
  }
  ...
  __pyx_4 = PyFloat_FromDouble(logmath_exp(((struct __pyx_obj_10sphinxbase_NGramModel *)__pyx_v_self)->lmath,__pyx_v_score)); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 145; goto __pyx_L1;}
  __pyx_5 = PyInt_FromLong(__pyx_v_n_used); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 145; goto __pyx_L1;}
  __pyx_6 = PyTuple_New(2); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 145; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_6, 0, __pyx_4);
  PyTuple_SET_ITEM(__pyx_6, 1, __pyx_5);
  __pyx_4 = 0;
  __pyx_5 = 0;
...
PyMODINIT_FUNC initsphinxbase(void) {
  ...
  __pyx_4 = PyFloat_FromDouble(1.0); if (!__pyx_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; goto __pyx_L1;}
  __pyx_k4 = __pyx_4;
  __pyx_4 = 0;
  __pyx_5 = PyFloat_FromDouble(1.0); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; goto __pyx_L1;}
  __pyx_k5 = __pyx_5;
  __pyx_5 = 0;
  __pyx_6 = PyFloat_FromDouble(1.0); if (!__pyx_6) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; goto __pyx_L1;}
  __pyx_k6 = __pyx_6;
  __pyx_6 = 0;
